...
function cbfa_proxy_handler() {
    ...
    $chatbase_api_url = "https://www.chatbase.co/api/v1/chat"; // ChatBase URL remains hidden here
    ...
    echo $response; // Send the raw JSON response back to the client

    wp_die(); // Required termination for WordPress AJAX handlers
}