...
function cbfa_register_settings() {
    ...
    register_setting('cbfa_options_group', 'cbfa_agent_image_url'); // NEW: Agent Image URL setting
    ...
    add_settings_field('cbfa_agent_image_field', 'Agent Avatar', 'cbfa_agent_image_url_callback', 'chatbase-assistant', 'cbfa_main_section'); // NEW: Image Field
}
...
function cbfa_enqueue_frontend_scripts() {
    ...
    wp_enqueue_script(
        ...
        array('jquery'),
        '1.0.3', // Bumping version for cache bust and new logic
    ...
    wp_localize_script(
        ...
        array(
            ...
            'agent_image_url' => get_option('cbfa_agent_image_url', ''), // NEW: Image URL
            'default_agent_image' => CBFA_PLUGIN_URL . 'assets/default-agent.png', // NEW: Default image path
